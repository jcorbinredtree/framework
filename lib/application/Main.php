...
{       
    ...
    /**
     * parses the directory style name/value pairs
     *
     * @return void
     */
    public static function parseSefLinks()
    {
        global $config;
    ...
    {            
        ...
        {        
             ...
             */
            $class = $current->theme->getClass();        
            Application::setPath("$config->absPath/themes/$class"); 
