...
class Image_Toolbox
{
    ...
    {
        return $this->_img['main']['resource'];        
    }
    
    function asString()
    {
        ob_start();            
        imagejpeg($this->_img['main']['resource'], null, IMAGE_TOOLBOX_DEFAULT_JPEG_QUALITY);
    ...
    function newOutputSize($width, $height, $mode = 0, $autorotate = false, $bgcolor = '#000000')
    {
        if ($width > 0 && $height > 0 && is_int($width) && is_int($height)) {
            ...
            /*
            print ($width == 0 && $height > 0) ? 'yes' : 'no';
            print "<br>";
            print ($width > 0 && $height == 0) ? 'yes' : 'no';
            print "<br>";
            print is_int($width) ? 'yes' : 'no';
